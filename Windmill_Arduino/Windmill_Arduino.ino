...
unsigned long myChannelNumber = 741312;
const char myWriteAPIKey = "DMUVT3B4VG4RMJH8";

//String apiKey = "DMUVT3B4VG4RMJH8";     // replace with your channel's thingspeak WRITE API key

String ssid="SMECLABS";    // Wifi network SSID
String password ="Red-1door";  // Wifi network password
...
void setup() {
 ...
 lcd.setCursor(0,1);
 lcd.print("JAYA ENGG CLG");
 Serial.println("JAYA ENGG CLG");
 Serial.println("");
 delay(300);
 lcd.clear();
 lcd.display();
 ...
 lcd.setCursor(0,1);
 lcd.print("110815107014");
 Serial.println("110815107014");
 delay(500);
 lcd.clear();
 lcd.display();
 lcd.setCursor(0,0);
 ...
 lcd.setCursor(0,1);
 lcd.print("110815107030");
 Serial.println("110815107030");
 delay(500);
 lcd.clear();
 lcd.display();
 lcd.setCursor(0,0);
 ...
 lcd.setCursor(0,1);
 lcd.print("110815107043");
 Serial.println("110815107043");
 Serial.println("");
 delay(500);
 lcd.clear();
 lcd.display();
